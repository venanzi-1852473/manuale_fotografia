...
Schema presente in Figura~\ref{fig:dslr_schema}
...
\footnote{È un problema noto con diverse mirrorless quando si registrano video. Se invece si scattano foto, con una normale temperatura ambientale, non è certamente un problema.}
